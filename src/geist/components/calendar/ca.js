const b1 = ({
  ...
  let { presets: M } = S,
    [D, R] = (0, y.useState)(e),
    [W, A] = (0, y.useState)(void 0),
    [O, P] = (0, y.useState)(ba(S)?.key || null),
    H = (0, m0.useIsMobile)(),
    L = (0, y.useCallback)(() => {
      H || R(!1)
    }, [H])
  ...
  let U = (0, y.useCallback)(
    ...
    $ = (function (e) {
      ...
      let { value: r, defaultValue: i, onChange: n, isDateExceedsLimit: a, ...l } = e,
        ...
        h = (function (e) {
          let [t, r] = bq(e.value || void 0, e.defaultValue, e.onChange),
            i = t ? new Date(t) : null,
            n = i || new Date(),
            [a, l] = (0, y.useState)(n),
            [s, o] = (0, y.useState)(n),
            [u, d] = (0, y.useState)(e.autoFocus || !1),
            c = a.getMonth(),
            h = a.getFullYear(),
            m = bJ(),
            f = (um(a).getDay() - m) % 7
          ...
          return {
            ...
            isInvalid: (e) => bX(e, b, x),
            isSelected: (e) => uc(e, t),
            isCellFocused: (e) => u && s && uc(e, s),
            isCellDisabled: (t) => e.isDisabled || bX(t, b, x),
            isPreviousMonthInvalid: () => bX(us(bo(a, -1, void 0)), b, null),
            isNextMonthInvalid: () => bX(um(bo(a, 1)), b, x),
          }
        })({ ...l, value: s && s.start }),
        m = (0, y.useMemo)(() => (u ? new Date(Math.min(u.end.getTime(), Date.now())) : null), [u]),
        f = d ? bQ(d, h.focusedDate) : s && bQ(u.start, m),
        g = (t) => {
          e.isReadOnly || (d ? (o(bQ(d, t, e.minValue, e.maxValue)), c(null)) : c(t))
        }
      return {
        ...h,
        value: u,
  ...
  let G = (0, y.useMemo)(
    ...
    Y = (0, y.useMemo)(() => $.value?.end || new Date(m$.local().endOf('day').toISO()), [$.value]),
    V = (function (e, t) {
      let r = pU(bV),
        ...
        l = (function (e, t, r) {
          let { isReadOnly: i = !1, isDisabled: n = !1 } = e,
            ...
            { direction: h } = pB()
          ;(bG(() => {
            t.isFocused || bB(s.format(t.currentMonth))
          }, [t.currentMonth]),
            bG(() => {
              r && bB(r)
            }, [r]))
          ...
          return {
            calendarProps: (0, bL.mergeProps)(a, { ...m, id: u, role: 'group' }),
            calendarTitleProps: {
              id: d,
            },
            nextButtonProps: {
      ...
      return (
        (l.calendarBodyProps = (0, bL.mergeProps)(l.calendarBodyProps, {
    ...
    en = (function ({
      ...
      let [s, o] = (0, y.useState)(e?.text ?? ''),
        [u, d] = (0, y.useState)(''),
        [c, h] = (0, y.useState)(!1),
        [m, f] = (0, y.useState)(null),
        [g, p] = (0, y.useState)(!1),
        [b, x] = (0, y.useState)(!1),
        [v, w] = (0, y.useState)(!0),
        {
      ...
      let C = (0, y.useCallback)(
        ...
        N = (0, y.useMemo)(
          () => null === bl(t, r.value) && !(0, p3.isEqual)(r.value, m),
          [r, m, t]
        ),
        k = n && !!(s || N),
        E = (0, y.useMemo)(
    ...
    ea = (0, y.useMemo)(() => (O || en.isFocused ? 'preset' : 'calendar'), [en.isFocused, O]),
    el = h && 'preset' === ea,
    es = !!$.value?.start && w,
    eo = {
      className: o,
        ...
        ? `${((
            ...
            let l = uC(e, t),
              ...
              h = (e) => {
                let t
                return (
                  (t = (e.toLocaleTimeString(i, { hour: '2-digit', minute: '2-digit' }) || '')
                    .replaceAll(' AM', 'am')
  ...
  ;(0, y.useEffect)(() => {
    function e(e) {
      ...
      l && ((B.current = !0), $.setValue(l), (B.current = !1), $.focusCell(l.start), A(a))
    }
    return (
  ...
  let eh = (0, y.useMemo)(() => (v ? (_ ? 520 : null) : 280), [v, _]),
    em = (0, y.useMemo)(
      () =>
        dm(
          (function (e) {
